...
class Client {
    constructor() {
        ...
        this.realtime = {
            ...
            createSocket: () => {
                var _a, _b;
                console.log(`Creating socket, channelSize: ${this.realtime.channels.size}`);
                    ...
                    this.realtime.socket.addEventListener("close", (event) => {
                        ...
                        if (!this.realtime.reconnect ||
                            (((_b = (_a = this.realtime) === null || _a === void 0 ? void 0 : _a.lastMessage) === null || _b === void 0 ? void 0 : _b.type) === "error" && // Check if last message was of type error
                                ((_c = this.realtime) === null || _c === void 0 ? void 0 : _c.lastMessage.data).code ===
            ...
            cleanUp: (channels) => {
                this.realtime.channels.forEach((channel) => {
                    console.log("Channel in cleanup: ", channel);
    ...
    setEndpointRealtime(endpointRealtime) {
        ...
        console.log("Set realtime endpoint");
        return this;
    }
    /**
     * Set Project
    ...
    unsubscribe(counter, channelArray) {
        this.realtime.subscriptions.delete(counter);
        this.realtime.cleanUp(channelArray);
        this.realtime.connect();
    }
